...
public class OverseerCollectionProcessor implements Runnable, ClosableThread {
	  ...
	  public OverseerCollectionProcessor(ZkStateReader zkStateReader, String myId,  String adminPath) {
	    this(zkStateReader, myId, adminPath, Overseer.getCollectionQueue(zkStateReader.getZkClient()));
	  }

	  protected OverseerCollectionProcessor(ZkStateReader zkStateReader, String myId,  String adminPath, DistributedQueue workQueue) {
...
*/
	...
	/*  private void createCollection(ClusterState clusterState, ZkNodeProps message, NamedList results) {
	    ...
	    if (clusterState.getCollections().contains(collectionName)) {
	      throw new RuntimeException("collection already exists: " + collectionName);
	    }
